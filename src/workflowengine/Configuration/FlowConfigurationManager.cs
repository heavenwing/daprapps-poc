...
namespace Dapr.Workflows.Configuration
{
    public class FlowConfigurationManager : AzureConfigurationManager
    {
        ...
        {
            string connectionString = $"DefaultEndpointsProtocol=https;AccountName={credentials.StorageAccountName};AccountKey={credentials.StorageAccountKey};EndpointSuffix={credentials.StorageEndpointSuffix}";
