...
namespace Dapr.Workflows
{
    ...
    class Program
    {
        ...
        const string StorageEndpointSuffix = "STORAGE_ENDPOINT_SUFFIX";
        ...
        static void Main(string[] args)
        {
            ...
            var storageEndpointSuffix = string.Empty;
            if (envVars.Contains(StorageEndpointSuffix))
            {
                storageEndpointSuffix = envVars[StorageEndpointSuffix].ToString();
            }
            else
            {
                const string DefaultStorageAccountEndpointSuffix = "core.windows.net";
                storageEndpointSuffix = DefaultStorageAccountEndpointSuffix;
            }
            ...
            {
                throw new Exception($"{StorageEndpointSuffix} environment variablec cannot be empty");
            }

            // Create engine
            var credentials = new Credentials(storageAccountName, storageAccountKey, storageEndpointSuffix);
